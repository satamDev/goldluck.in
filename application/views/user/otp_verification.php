            ...
            <div class="col-lg-6 col-md-8 mx-auto" style="margin-top: 7%;">
                <div class="login">
                  <div id="CustomerLoginForm">
                    <form method="post" action="<?=base_url()?>otpverification">
                    <div class="login-form-container">
                      ...
                      <div class="login-form">
                        ...
                        <input type="number" name="otp" class="input-full" placeholder="Enter OTP">
                        <input type="hidden" name="for" value="<?=($this->session->has_userdata('otp_for')?$this->session->userdata('otp_for') :'' )?>">
                        <div class="login-toggle-btn">
                          <div class="form-action-button">
                           <button type="submit" class="btn1 w-100">Verify</button>                        
                          </div>
